    ...
    <section class="section-padding footer-mid">
        <div class="container pt-15 pb-20">
            <div class="row">
                ...
                <div class=" col-xl-2 col-lg-2 col-md-12 col-sm-12  wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                    <h4 class="widget-title widget-title-content">Company</h4>
                ...
                <div class=" col-xl-2 col-lg-2 col-md-12 col-sm-12  wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                    ...
                    <ul class="footer-list  mb-sm-5 mb-md-0">
                        ...
                        <li><a href="{{ url('get-discount') }}">Get Discount</a></li>
                    </ul>
                </div>
